#pragma checksum "C:\Workspace\Github\Moov\Moov-WebApplication-Project\Views\Moov\Onboarding.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7742f4936d365a57f5e545d072023bb9b3a2d852"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7742f4936d365a57f5e545d072023bb9b3a2d852", @"/Views/Moov/Onboarding.cshtml")]
...
#nullable disable
        ...
        onboarding.onResourceCreated = ({ resourceType, resource }) => {
            if (resourceType === ""account"") {
                ...
                var sc = `/fed.read,/accounts/${newAccountID}/bank-accounts.read,/accounts/${newAccountID}/bank-accounts.write,/accounts/${newAccountID");
            WriteLiteral(@"}/capabilities.read,/accounts/${newAccountID}/capabilities.write,/accounts/${newAccountID}/cards.read,/accounts/${newAccountID}/cards.write,/accounts/${newAccountID}/profile.read,/accounts/${newAccountID}/profile.write,/accounts/${newAccountID}/representatives.read,/accounts/${newAccountID}/representatives.write`;
                // TODO: Then again if you need token with new scopes, make anajax call to token request with new scopes
                $.ajax({
                    url: '/Moov/Token', // setting url  //Moov/Token
                    type: 'POST',
                    dataType: 'text',
                    ...
                    success: function (response) {
                        ...
                        console.log(""Token === "");
       ");
            WriteLiteral(@"                 console.log(myToken2);
                          ...
                          moov.accounts.bankAccounts.link({plaid: { token: myToken2}});
                           
                            moov.plaid.initialize({
          ");
            WriteLiteral(@"                    accountID: newAccountID,
                              redirectURL: ""https://localhost:44354"",
