#pragma checksum "C:\Workspace\Github\Moov\Moov-WebApplication-Project\Views\Moov\Onboarding.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "441c4059c39fd34f945712ddf95ea2f51049a06d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"441c4059c39fd34f945712ddf95ea2f51049a06d", @"/Views/Moov/Onboarding.cshtml")]
...
#nullable disable
        ...
        onboarding.onResourceCreated = ({ resourceType, resource }) => {
            if (resourceType === ""account"") {
                ...
                var sc = `/profile-enrichment.read,/fed.read,/accounts/${newAccountID}/bank-accounts.read,/accounts/${newAccountID}/bank-accounts.write");
            WriteLiteral(@",/accounts/${newAccountID}/capabilities.read,/accounts/${newAccountID}/capabilities.write,/accounts/${newAccountID}/cards.read,/accounts/${newAccountID}/cards.write,/accounts/${newAccountID}/profile.read,/accounts/${newAccountID}/profile.write,/accounts/${newAccountID}/representatives.read,/accounts/${newAccountID}/representatives.write`;
